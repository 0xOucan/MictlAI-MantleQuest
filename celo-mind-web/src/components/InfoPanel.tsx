    ...
    <div className="max-w-4xl mx-auto">
      <MetallicPanel className="overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 border-t-3 border-mictlai-gold/50">
          <MetallicPanel variant="gold" className="p-6 md:border-r-3 border-mictlai-gold/50">
            <div className="text-2xl mb-2 pixel-pulse">🤖</div>
            <h3 className="font-pixel font-bold text-mictlai-obsidian text-lg mb-2">NEBULA AI</h3>
            <p className="text-mictlai-obsidian font-pixel text-sm">
              ADVANCED AI ASSISTANT FOR DEFI OPERATIONS AND NATURAL LANGUAGE BLOCKCHAIN INTERACTIONS
            </p>
          </MetallicPanel>
          <MetallicPanel variant="turquoise" className="p-6 md:border-r-3 border-mictlai-gold/50">
            <div className="text-2xl mb-2 pixel-pulse">🌳</div>
            <h3 className="font-pixel font-bold text-mictlai-obsidian text-lg mb-2">TREEHOUSE PROTOCOL</h3>
            <p className="text-mictlai-obsidian font-pixel text-sm">
          ...
          <MetallicPanel variant="gold" className="p-6 md:border-r-3 border-mictlai-gold/50">
            <div className="text-2xl mb-2 pixel-pulse">🏦</div>
            <h3 className="font-pixel font-bold text-mictlai-obsidian text-lg mb-2">LENDLE PROTOCOL</h3>
            <p className="text-mictlai-obsidian font-pixel text-sm">
              SUPPLY MNT AND USDT AS COLLATERAL FOR LENDING AND BORROWING OPERATIONS
            </p>
          </MetallicPanel>
          <MetallicPanel variant="turquoise" className="p-6">
            <div className="text-2xl mb-2 pixel-pulse">🔄</div>
            <h3 className="font-pixel font-bold text-mictlai-obsidian text-lg mb-2">MERCHANT MOE</h3>
            <p className="text-mictlai-obsidian font-pixel text-sm">
      ...
      {/* Description */}
      <MetallicPanel className="mt-10 px-4 md:px-8 py-8">
        ...
        <MetallicPanel variant="turquoise" className="p-4 mt-6">
          <h3 className="text-xl font-pixel font-bold text-mictlai-obsidian mb-3">🤖 NEBULA AI POWERED INTERACTIONS:</h3>
          <div className="pixel-divider border-mictlai-obsidian/30"></div>
          <ul className="space-y-3 text-mictlai-obsidian font-pixel text-sm mb-6">
            <li className="flex items-start">
              <span className="inline-block mr-2 text-mictlai-obsidian">▸</span>
              <span><span className="font-medium text-mictlai-obsidian">NATURAL LANGUAGE DEFI:</span> EXECUTE COMPLEX OPERATIONS USING PLAIN ENGLISH</span>
            </li>
            <li className="flex items-start">
              <span className="inline-block mr-2 text-mictlai-obsidian">▸</span>
              <span><span className="font-medium text-mictlai-obsidian">PORTFOLIO ANALYSIS:</span> AI-POWERED INSIGHTS AND YIELD OPTIMIZATION</span>
            </li>
            <li className="flex items-start">
              <span className="inline-block mr-2 text-mictlai-obsidian">▸</span>
              <span><span className="font-medium text-mictlai-obsidian">STRATEGY RECOMMENDATIONS:</span> PERSONALIZED DEFI STRATEGY SUGGESTIONS</span>
            </li>
          </ul>
        </MetallicPanel>
        
        <MetallicPanel variant="gold" className="p-4 mt-6">
          <h3 className="text-xl font-pixel font-bold text-mictlai-obsidian mb-3">SUPPORTED NETWORKS & PROTOCOLS:</h3>
          <div className="pixel-divider border-mictlai-obsidian/30"></div>
          <ul className="space-y-4 text-mictlai-obsidian font-pixel text-sm">
            <li className="flex items-start">
              <span className="inline-block mr-2 text-mictlai-obsidian">▸</span>
              <span><span className="font-medium text-mictlai-obsidian">BASE NETWORK:</span> TRANSFER XOC TOKENS TO ARBITRUM, MANTLE, AND ZKSYNC ERA</span>
            </li>
            <li className="flex items-start">
              <span className="inline-block mr-2 text-mictlai-obsidian">▸</span>
              <span><span className="font-medium text-mictlai-obsidian">ARBITRUM NETWORK:</span> TRANSFER MXNB TOKENS TO BASE, MANTLE, AND ZKSYNC ERA</span>
            </li>
            <li className="flex items-start">
              <span className="inline-block mr-2 text-mictlai-obsidian">▸</span>
              <span><span className="font-medium text-mictlai-obsidian">MANTLE NETWORK:</span> FULL ECOSYSTEM INTEGRATION WITH NEBULA AI, TREEHOUSE PROTOCOL STAKING, LENDLE PROTOCOL LENDING/BORROWING, MERCHANT MOE DEX OPERATIONS, AND CROSS-CHAIN BRIDGING</span>
            </li>
            <li className="flex items-start">
              <span className="inline-block mr-2 text-mictlai-obsidian">▸</span>
              <span><span className="font-medium text-mictlai-obsidian">ZKSYNC ERA:</span> TRANSFER USDT TOKENS TO AND FROM ALL SUPPORTED NETWORKS</span>
            </li>
          </ul>
        </MetallicPanel>
